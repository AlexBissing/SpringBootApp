...
@WithUserDetails("alexbissing")
@TestPropertySource("/application-test.properties")
@Sql(value = {"/create-user-before.sql", "/message-list-before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/message-list-after", "/create-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("alex"));
    }
    ...
    public void addMessageToList() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]").string("#new one"));
    }
